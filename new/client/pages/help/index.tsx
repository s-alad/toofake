    ...
    return (
        <div className={s.help}>
            ...
            <div className={s.brief}>
                ...
                <p>This project is completely <a href="https://github.com/s-alad/toofake">open source</a> and still a work in progress. Theres many issues that I know of and that I dont know of; Feel free to reach out with bugs or to contribute! </p>
            ...
            <div className={s.faq} id="FAQ">
                ...
                <div className={s.qa}>
                    <div className={s.q}>
                        ...
                        <p>TooFake, the BeFake project, and the old BeFake website have been running for over 10 months without anybody getting banned. Trends show you are safe! But as with everything theres always a small risk.</p>
                    </div>
                    <div className={s.q}>
                    ...
                    <div className={s.q}>
                        <h3>Can I screenshot or download friend's BeReals?</h3>
                        <p>Yes, you can take screenshots without notifying your friends. You can also press the download button on the bottom left of a BeReal to download the primary image</p>
                    </div>
                    <div className={s.q}>
                    ...
                    <div className={s.q}>
                        <h3>Why does the page im at go entirely black or have a client side exception?</h3>
                        <p>This might happen if there is some error that arises we haven't handled. Please refresh the page or re-login</p>
                    </div>
                </div>
            </div>
            ...
            <div className={s.use} id="how-to-use">
                ...
                <div className={s.uses}>
                    ...
                    <div className={s.use}>
                        ...
                        <p>You can post BeReals by clicking post on the navigation menu. Select your primary and secondary image and add a caption. Submit the image and hopefully it'll get posted. Posting does not support iphone images (.heic & .heif) or .webp images.</p>
                    </div>
                    <div className={s.use}>
