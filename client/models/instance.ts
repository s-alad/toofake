...
class Instance {
  ...
  static async create(raw: any) {
    ...
    let creationdate = new Date(raw.creationDate).toLocaleString(undefined, {
      hour: "2-digit",
      minute: "2-digit",
      month: "short",
      day: "numeric",
  ...
  static async moment(raw: any, rawuser: any) {
    ...
    let creationdate = raw.creationDate
      ? new Date(raw.creationDate).toLocaleString(undefined, {
          hour: "2-digit",
          minute: "2-digit",
          month: "short",
          day: "numeric",
