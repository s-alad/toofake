      ...
      <div className={s.navigation}>
        {!menu ? (
          <>
            ...
            <div className={s.pagename}>{getPageName()}</div>
          </>
        ) : (
          ...
          {router.pathname == "/feed" ? (
            <>
              ...
              <span className={s.item}>
                <button onClick={() => logout(router, localStorage)}>
                  logout
                </button>
              </span>
            ...
            <>
              <Link href="/help" className={s.item}>
                <button>about</button>
              </Link>
              <Link href="/help#how-to-use" className={s.item}>
                <button>help</button>
              </Link>
              <Link href="/help#FAQ" className={s.item}>
                <button>faq</button>
              </Link>
            </>
          ) : (
        ...
        <div className={s.mobile}>
          {router.pathname == "/feed" ? (
            <>
              <div
                className={`${s.menu} ${menu ? s.menuopen : ""}`}
            ...
            <div className={s.helpmobile}>
              ...
              <Link href="/help#how-to-use" className={""}>
                help
              </Link>
              <Link href="/help#FAQ" className={""}>
                faq
              </Link>
            </div>
